...
export default function EnterprisePage() {
  ...
  return (
    <div className="pt-28 pb-20 relative">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-4xl space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <a
              href="#inquiry"
              className="px-6 py-3.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-sm transition-all duration-200 flex items-center gap-2 shadow-lg shadow-indigo-600/30"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={idx} className="p-6 rounded-2xl bg-zinc-900/40 border border-white/10 space-y-3">
      ...
      <section id="inquiry" className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t border-white/5">
        <div className="rounded-3xl bg-zinc-900/60 border border-white/10 p-8 sm:p-12 backdrop-blur-md">
          ...
          {formSubmitted ? (
            <div className="p-6 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-300 space-y-3">
