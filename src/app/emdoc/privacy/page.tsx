      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-4 pt-2">
            <div className="relative w-14 h-14 rounded-2xl overflow-hidden border border-white/15 bg-zinc-800 shadow-xl shrink-0">
              <Image
          ...
          <p className="text-xs font-mono text-zinc-500 pt-1">
            Effective Date: September 6, 2026 • Published by COGIFY (<code className="text-zinc-400 font-mono">cogify.me</code>)
          </p>
        </div>

        {/* Highlight Callout Box: 100% Air-Gapped Guarantee */}
        <div className="mt-8 p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-emerald-950/40 via-zinc-900 to-zinc-950 border border-emerald-500/30 text-emerald-200 space-y-4 shadow-2xl">
          ...
          <div className="pt-2 border-t border-emerald-500/20 grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs font-mono">
        ...
        <div className="mt-12 space-y-12 text-sm text-zinc-300 leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc list-inside space-y-1.5 text-zinc-400 text-xs pl-2">
              <li>All optical character recognition is performed on-device using Apple&apos;s native Vision framework (<code className="text-zinc-300 font-mono">VNRecognizeTextRequest</code>) accelerated by the Apple Neural Engine.</li>
          ...
          <section className="space-y-3 pt-4 border-t border-white/5">
            <h2 className="text-lg font-bold text-white">8. Product Support & Privacy Contacts</h2>
            <p className="text-zinc-400">
            ...
            <div className="p-4 rounded-xl bg-zinc-900/60 border border-white/5 text-xs font-mono space-y-1.5">
              <div><strong>Application:</strong> EmDoc Workstation for macOS</div>
              <div><strong>Parent Company:</strong> COGIFY (<a href="https://cogify.me" className="text-indigo-400 underline">https://cogify.me</a>)</div>
              <div><strong>Creator & Lead Architect:</strong> Shubham Sharma (Delhi)</div>
              <div><strong>Product Support & Inquiries:</strong> <a href="mailto:contact@cogify.me" className="text-indigo-400 underline">contact@cogify.me</a></div>
              <div><strong>EmDoc Product Page:</strong> <a href="https://cogify.me/emdoc" className="text-indigo-400 underline">https://cogify.me/emdoc</a></div>
            </div>
          </section>
        </div>
      </div>
