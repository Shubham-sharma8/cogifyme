      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-4xl space-y-6">
          <div className="flex items-center space-x-3">
            <div className="relative w-12 h-12 rounded-2xl overflow-hidden border border-white/10 shadow-lg bg-zinc-800">
              <Image
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            ...
            <Link
              href="/emdoc/privacy"
              className="px-6 py-3.5 rounded-xl bg-emerald-950/40 hover:bg-emerald-900/40 text-emerald-300 hover:text-emerald-200 font-semibold text-sm border border-emerald-500/30 transition-colors flex items-center gap-2"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl bg-zinc-900/40 border border-white/10 space-y-3">
            ...
            <h3 className="text-base font-bold text-white">100% Air-Gapped Privacy</h3>
            ...
            <Link
              href="/emdoc/privacy"
              className="inline-flex items-center gap-1 text-xs text-emerald-400 hover:text-emerald-300 font-medium pt-1"
            >
          ...
          <div className="p-6 rounded-2xl bg-zinc-900/40 border border-white/10 space-y-3">
            ...
            <h3 className="text-base font-bold text-white">Modern C++20 Core</h3>
            <p className="text-xs text-zinc-400 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-zinc-900/40 border border-white/10 space-y-3">
            ...
            <h3 className="text-base font-bold text-white">Zero Telemetry & Bloat</h3>
            <p className="text-xs text-zinc-400 leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={idx} className="p-6 rounded-2xl bg-zinc-900/30 border border-white/10 space-y-3">
            ...
            <tbody className="divide-y divide-white/5">
              {emdoc.specifications.map((spec, idx) => (
                <tr key={idx} className="hover:bg-white/[0.02] transition-colors">
                  <td className="py-4 px-6 font-semibold text-zinc-400 w-1/3">
                    {spec.label}
                  </td>
                  <td className="py-4 px-6 text-zinc-200 font-mono">
                    {spec.value}
                  </td>
                </tr>
              ))}
