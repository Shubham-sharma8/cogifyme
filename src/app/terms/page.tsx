        ...
        <div className="mt-12 space-y-10 text-sm text-zinc-300 leading-relaxed">
          <section className="space-y-3">
            ...
            <p className="text-zinc-400">
              By accessing our website (<a href="https://cogify.me" className="text-indigo-400 underline">https://cogify.me</a>) or downloading and evaluating our software products (including EmDoc), you agree to be bound by these Terms of Use and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this site and our software.
            </p>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-bold text-white">2. Software License & Usage</h2>
            <p className="text-zinc-400">
          ...
          <section className="space-y-3">
            ...
            <p className="text-zinc-400">
              <strong>Your Documents:</strong> COGIFY claims zero ownership, license, or rights in any documents, files, annotations, signatures, or content that you process using EmDoc. Because EmDoc operates 100% air-gapped on your local computer, your files remain strictly your property and under your exclusive control.
            </p>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-bold text-white">4. Privacy Policy</h2>
            <p className="text-zinc-400">
              Your use of our website and applications is also governed by our Privacy Policies. Please review our <Link href="/privacy" className="text-indigo-400 underline">Website Privacy Policy</Link> and the dedicated <Link href="/emdoc/privacy" className="text-indigo-400 underline font-semibold">EmDoc Air-Gapped Privacy Policy</Link>.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <div className="p-4 rounded-xl bg-zinc-900/60 border border-white/5 text-xs font-mono space-y-1">
              ...
              <div>Email: <a href={`mailto:${siteConfig.contact.general}`} className="text-indigo-400 underline">{siteConfig.contact.general}</a></div>
              <div>EmDoc Support: <a href={`mailto:${siteConfig.contact.emdocSupport}`} className="text-indigo-400 underline">{siteConfig.contact.emdocSupport}</a></div>
            </div>
          </section>
        </div>
      </div>
