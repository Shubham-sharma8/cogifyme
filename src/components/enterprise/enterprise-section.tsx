        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-zinc-900 dark:text-white leading-tight">
              Software for <span className="text-indigo-600 dark:text-indigo-400">Enterprise.</span>
            </h2>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {capabilities.map((item, idx) => (
              <div
                key={idx}
                className="p-6 rounded-2xl bg-white/90 dark:bg-zinc-900/40 border border-zinc-200/90 dark:border-white/10 hover:border-indigo-500/40 transition-all duration-200 backdrop-blur-sm shadow-xs dark:shadow-none"
              >
                <div className="w-10 h-10 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/80 dark:border-white/10 flex items-center justify-center mb-4">
                  {item.icon}
                </div>
